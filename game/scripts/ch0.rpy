...
label chplotadvice_yangsy:
    ...
    yangsy "首先让大部分所有群员全都欢迎一句；可以顺便加点群员之间的互动"
    yangsy "然后各种小事发生时需要搞些选项能跟涉事成员交谈，提高进线可能"
    yangsy "自己的剧情自己写，写成啥样都没关系，后面会有人专门负责精修的"
    yangsy "等主角熟悉群内环境之后就可以安排全体打算让主角做个魔改试试水"
    yangsy "如果主角选择去尝试创作魔改，就让主角进创作者线，否则进普通线"
    yangsy "前者攻略Gra，Yangsy等创作者，后者攻略Morin，ms_win等普通成员"
    yangsy "也就是说要把攻略线拆成作者线和普通线的后续分支而不是平行时空"
    yangsy "然后就再来点什么其他的小事，依旧，跟涉事成员交谈提高进线可能"
    yangsy "不要直接让玩家直接选攻略谁，而是根据平时选了谁的选项自动决定"
    yangsy "两次漫展主要用于提供选项以判断正在攻略的角色；决定不了就共通"
    yangsy "螃蟹事件啊群聊解散啊这种刀子剧情虽说确实经历过但还是别写了（"
    yangsy "最终结局和二周目meta线就到时候再说了，这都不是现在的首要事项"
    yangsy "哦对如果你还没发现Yangsy每句长度都一样的话Yangsy会很失望的（"
    yangsy "当然游戏内的字体并不是等宽字体所以这点很难看出来就是了（（（"