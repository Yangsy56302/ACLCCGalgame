label ch0:
    ...
    "在刷了几个下方的推荐视频后，{w=0.25}你萌生了尝试的想法，\n{w=0.5}不过那时的你并没有零花钱。"
    ...
    "在将游戏里的关卡翻来覆去的打了好几遍之后，{w=0.25}你开始觉得无聊了。"
    "作为一个社区内容占了极大比例的游戏，\n{w=0.25}“渠道版”不能联网的弊端越发明显。"
    "虽然游戏里也内置了编辑器，{w=0.25}但是那时的你对此一窍不通。"
    "在网站上看到的关卡，{w=0.25}简介里的链接也往往是创意工坊或是外网的云盘。"

    "最终，{w=0.25}在经历了几天的心理斗争之后，{w=0.25}你跟着网上的教程下载了Sbeam，\n{w=0.5}又偷偷用父母的信用卡笨拙地按照指示付了款。"

    stop music fadeout 2.0

    "然而，{w=0.25}在你购买游戏后没几天，{w=0.25}国外论坛在国内有了{green}镜像服务器{/green}，\n{w=0.25}可以方便的下载谱面。"
    "这让你的心理斗争与购买游戏的行为显得如此愚蠢。"

    play music "mus_astral_calm.mp3" volume 0.3 fadein 1.0
    $ renpy.notify("♪ ms_win_and_mc - Astral Calm")

    "虽然你在知道这则消息之后气的跳脚，{w=0.25}但是你并没有抛弃这款游戏。"
    "一方面是，{w=0.25}你认为这是第一个属于自己的东西。"
    "那时候的家里，{w=0.25}电脑是父母的，{w=0.25}手机是父母的，{w=0.25}钱也是父母的。"
    "虽然买游戏的钱来自父母，{w=0.25}但是你觉得游戏是属于自己的，{w=0.25}有了感情。"
    "另外一方面是，{w=0.5}26元对你而言真的很贵。"
    "总之，在购买了正版之后，你接触到了更多你喜欢的谱面，技术也在一天一天的提高。"
    ...
    "像以前一样，{w=0.25}他们问了你钱的来源，{w=0.25}钱的数目，{w=0.25}买了什么东西，\n{w=0.25}以及做这一切的原因。"
    "在这期间，{w=0.25}他们一直在用这种眼神与你对视，{w=0.25}长达数分钟。"
    "最后，{w=0.5}随着一句{w=0.5}{color=#ff9999}“下不为例。”{/color}，{w=0.5}谈话结束。"
    "这样的谈话你已经经历了很多次。"
    "对你的父母来说，{w=0.5}他们并不觉得你会误入歧途，\n{w=0.5}但也没在你身上看见可能。"
    "父母都忙于生计，{w=0.25}并不关注你，{w=0.25}他们也认为你懂事，\n{w=0.25}因此家庭氛围还算融洽。"
    "而这样的家庭也养成了你内向的性格。"
