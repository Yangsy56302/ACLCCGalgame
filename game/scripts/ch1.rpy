label ch1:
    ...
    "你用父母的手机号注册了一个QQ，\n{w=0.5}使用在视频简介里发现的群号找到了群，{w=0.5}发送了入群申请。"
            ...
            "奥苯海墨与孙笑氚发明了铅早砹音和丰氚箱子":
                ...
                menu:
                    "[name_mc]":
                        mc.nvl "我叫[name_mc]"       
    gra.nvl "行，就这么叫你了"
    mc.nvl "Gra，{w=0.25}这个魔改到底是什么，{w=0.5}能给我讲讲吗？"
    mc.nvl "还有QQ怎么用\[笑哭\]"
    "{......}"
    "Gra 耐心地跟你解释了各种事情：\n{w=1.0}什么是魔改，{w=0.5}QQ怎么用，{w=0.5}以及关于QQ群聊的一些信息{...}"
    "你还了解到，{w=0.5}Gra 也是一名魔改作者，\n{w=0.5}而在这个群里还有好几位像 Gra 一样的魔改作者。"
    "你本来还想继续询问“该怎么做魔改”之类的更多疑问——\n{w=0.5}但你母亲却已经在催你去睡觉了。"
    nvl clear
    mc.nvl "Gra，{w=0.25}我先不聊了，{w=0.5}我母亲叫我睡觉了"
    gra.nvl "祝你好梦"
    "你躺在床上回想今天发生的一切，{w=0.5}心中充满了干劲，{w=0.5}很快就进入了梦乡。"
    "窗外繁星点点，{w=0.5}或许{w=0.25}象征着天[[原文如此]数个明天吧。"
    return